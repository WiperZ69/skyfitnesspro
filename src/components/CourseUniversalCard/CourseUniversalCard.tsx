...
interface CourseUniversalCardProps {
	course: Course
	progress?: number
...
export default function CourseUniversalCard({
	course,
	progress,
	onOpenTrainings,
	onResetProgress,
	...
	const handleToggle = (e: React.MouseEvent) => {
		...
		if (!isAuthenticated) return alert('Авторизуйтесь, чтобы добавлять курсы')

		if (alreadySelected) dispatch(removeCourse(course._id))
